...
class UpdateScheduleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'items.*.course_id' => 'required_with:items|exists:courses,id',
            'items.*.type' => 'required_with:items|in:theory,practical',
            'items.*.day_of_week' => 'required_with:items|in:sunday,monday,tuesday,wednesday,thursday,friday,saturday',
            'items.*.start_time' => 'required_with:items|date_format:H:i',
            'items.*.end_time' => 'required_with:items|date_format:H:i|after:items.*.start_time',
